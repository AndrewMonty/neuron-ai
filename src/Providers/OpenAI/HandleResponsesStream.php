...
trait HandleResponsesStream
{
     ...
     */
    public function streamResponse(array|string $messages, callable $executeToolsCallback): \Generator
    {
        $json = [
            'stream' => true,
            'model' => $this->model,
    ...
    {
        $output = array_values(array_filter($result['output'], function ($message) {
